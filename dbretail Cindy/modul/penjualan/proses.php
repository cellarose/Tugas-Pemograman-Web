...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Get the last inserted id_penjualan
    ...
    foreach ($penjualan as $item) {
        $sql = "INSERT INTO detail_penjualan (id_penjualan, id_barang, jumlah, harga, totalharga) 
                VALUES ('$id_penjualan', '$item[idbarang]', '$item[jumlah]', '$item[harga]', '$item[totalharga]')";
        $mysqli->query($sql);

        // Update stok barang in persediaan table
