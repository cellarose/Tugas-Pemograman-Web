...
<div class="row justify-content-center mt-3">
  <div class="col-7 bg-light-subtle me-3 p-3 shadow-sm">
    ...
    <div class="d-flex justify-content-between bg-warning-subtle p-3 shadow-sm">
      <h3>Total</h3>
      <h3 id="totalBayar"></h3>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label for="modalTotalBayar" class="form-label">Total Bayar</label>
      ...
      <select class="form-select" name="barang" id="barang" onchange="pilihBarang()">
        ...
        ?>
          <option value="<?= $row_barang['id_barang']; ?>" 
                  data-nama-barang="<?= $row_barang['nama_barang']; ?>" 
          ...
          <tr>
            ...
            <td>
              <div class="d-flex justify-content-between">
                <span>Rp.</span>
                <span><?= number_format($row_penjualan['harga'], 0, ',', '.'); ?></span>
              </div>
            </td>
            <td>
              <div class="d-flex justify-content-between">
                <span>Rp.</span>
                <span><?= number_format($row_penjualan['total_harga'], 0, ',', '.'); ?></span>
              </div>
            </td>
            <td>
        ...
        ?>
          <tr>
            ...
            <td>
              <div class="d-flex justify-content-between">
                <span>Rp.</span>
                <span><?= number_format($row_detailpenjualan['harga'], 0, ',', '.'); ?></span>
              </div>
            </td>
            <td>
              <div class="d-flex justify-content-between">
                <span>Rp.</span>
                <span><?= number_format($row_detailpenjualan['total_harga'], 0, ',', '.'); ?></span>
              </div>
            </td>
          </tr>
        <?php
